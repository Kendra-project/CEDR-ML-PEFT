...
//  double *result2, *result2imag;
  double *result2imag;
  dash_re_flt_type *result2;
  result2 = (dash_re_flt_type *)malloc(N * N * sizeof(dash_re_flt_type));
...
//  double *bufferinv1, *bufferinv2, *bufferinv3, *bufferinv4, *bufferinv5;
  ...
  dash_re_flt_type *bufferinv2, *bufferinv3;
  ...
  bufferinv2 = (dash_re_flt_type *)malloc(N * N * sizeof(dash_re_flt_type));
  bufferinv3 = (dash_re_flt_type *)malloc(N * N * sizeof(dash_re_flt_type));
  ...
  DASH_ZIP_flt((dash_cmplx_flt_type*)bufferinv2, (dash_cmplx_flt_type*)result2, (dash_cmplx_flt_type*)bufferinv3, N*N/2, ZIP_ADD);
