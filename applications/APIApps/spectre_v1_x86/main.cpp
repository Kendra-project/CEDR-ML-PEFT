...
uint8_t arr3[256 * 512];   
string secret = "CEDR_SECRET";  /* RETRIEVING THIS SECRET KEY IS THE GOAL OF THE ATTACKER */
...
const int NUM_TRIES = 500;         // The task of attacking and analysing is done NUM_TRIES times, then score is prepared for each character out of NUM_TRIES
