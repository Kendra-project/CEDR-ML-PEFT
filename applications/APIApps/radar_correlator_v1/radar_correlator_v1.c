...
int main(void)
{
    ...
    n_samples = 512; // it was 256
    dft_size = 2 * n_samples; // it was 2 * ..
    len = 2 * n_samples; // it was 2 *

    T = 0.002048; // it was  0.00512
    B = 5000000; // it was  500000
    sampling_rate = 10000; // it was  1000
    max_corr = 0;
    index = 0;
