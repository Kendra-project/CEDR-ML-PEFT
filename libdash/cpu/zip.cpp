  ...
  for (size_t i = 0; i < (*size); i++) {
    switch (*op) {
      ...
      case ZIP_SUB:
        ...
        break;
      case ZIP_MULT:
        (*output)[i].re = (*input_1)[i].re * (*input_2)[i].re - (*input_1)[i].im * (*input_2)[i].im;
        (*output)[i].im = (*input_1)[i].re * (*input_2)[i].im + (*input_1)[i].im * (*input_2)[i].re;
        break;
      case ZIP_DIV:
        (*output)[i].re = ( (*input_1)[i].re * (*input_2)[i].re + (*input_1)[i].im * (*input_2)[i].im)/((*input_2)[i].re*(*input_2)[i].re + (*input_2)[i].im*(*input_2)[i].im);
        (*output)[i].im = (-(*input_1)[i].re * (*input_2)[i].im + (*input_1)[i].im * (*input_2)[i].re)/((*input_2)[i].re*(*input_2)[i].re + (*input_2)[i].im*(*input_2)[i].im);
        break;
      /*case ZIP_CMP_MULT:
