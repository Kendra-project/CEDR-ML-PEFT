...
void DASH_ZIP_flt_cpu(dash_cmplx_flt_type** input_1, dash_cmplx_flt_type** input_2, dash_cmplx_flt_type** output, size_t* size, zip_op_t* op); // Added to support No-API applications on CEDR (running on CEDR worker thread)
...
void DASH_FFT_flt_cpu(dash_cmplx_flt_type** input, dash_cmplx_flt_type** output, size_t* size, bool* isForwardTransform); // Added to support No-API applications on CEDR (running on CEDR worker thread)
...
void DASH_GEMM_flt_cpu(dash_cmplx_flt_type** A, dash_cmplx_flt_type** B, dash_cmplx_flt_type** C, size_t* A_ROWS, size_t* A_COLS, size_t* B_COLS); // Added to support No-API applications on CEDR (running on CEDR worker thread)  
