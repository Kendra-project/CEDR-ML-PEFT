...
#define GLOBAL_UDMABUF_SIZE 1048576
...
#elif DASH_PLATFORM == DASH_AUP_ZU3
  #pragma message("=*=*= Building for AUP-ZU3 =*=*=")
  ...
  #define FFT_CONFIG_VIA_GPIO
  #define FFT_GPIO_CONFIG_DELAY 10
  #define FFT_CONTROL_BASE_ADDRS    ((uint32_t[]) {0x80020000, 0x80060000})
  #define FFT_DMA_CTRL_BASE_ADDRS   ((uint32_t[]) {0x80000000, 0x80080000})
  #define FFT_GPIO_RESET_BASE_ADDRS ((uint32_t[]) {0x80010000, 0x80070000})

  #define ZIP_UDMABUF_NUM 1
  #define ZIP_UDMABUF_SIZE GLOBAL_UDMABUF_SIZE
  #define ZIP_DMA_CTRL_BASE_ADDRS   ((uint32_t[]) {0x80030000, 0x80090000})
  #define ZIP_CONTROL_BASE_ADDRS    ((uint32_t[]) {0x80040000, 0x800B0000})
  #define ZIP_RESET_BASE_ADDRS      ((uint32_t[]) {0x80050000, 0x800A0000})
