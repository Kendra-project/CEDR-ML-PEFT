...
#define GLOBAL_UDMABUF_SIZE 1048576
...
#elif DASH_PLATFORM == DASH_VC707_3FFT_RISCV
  #pragma message("=*=*= Building for VC707 with 3FFTs =*=*=")
  ...
  #define FFT_CONFIG_VIA_GPIO
  #define FFT_GPIO_CONFIG_DELAY 10
  #define FFT_CONTROL_BASE_ADDRS    ((uint32_t[]) {0x60070000, 0x60080000})
  #define FFT_DMA_CTRL_BASE_ADDRS   ((uint32_t[]) {0x60040000, 0x60050000})
  #define FFT_GPIO_RESET_BASE_ADDRS ((uint32_t[]) {0x600A0000, 0x600B0000})

  #define HWSCHD_UDMABUF_NUM          1
  #define HWSCHD_UDMABUF_SIZE         GLOBAL_UDMABUF_SIZE
  #define HWSCHD_DMA_CTRL_BASE_ADDR   0x0
