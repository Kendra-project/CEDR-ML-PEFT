...
def generate_argparser():
    ...
    parser.add_argument('-r', dest='injectionRateCount', default=29, help='Number of injection rates used for the tests')
    return parser
                    ...
                    for c in range (CPUS-1,CPUS):
                        for sched in SCHEDS:
                            for i in range(INJ_COUNT):
                                row_to_write = []
                                resPoolComb = 'C'+str(c+1)+'+F'+str(f)+'+M'+str(m)+'+Z'+str(z) # Edit here
